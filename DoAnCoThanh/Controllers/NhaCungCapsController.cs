...
namespace DoAnCoThanh.Controllers
{
    ...
    public class NhaCungCapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNhaCungCap,TenNhaCungCap,DiaChi,SoDT")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNhaCungCap,TenNhaCungCap,DiaChi,SoDT")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
